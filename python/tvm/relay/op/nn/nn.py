...
def contrib_group_conv2d_nchwc(
        data,
        kernel,
        strides=(1, 1),
        padding=(0, 0),
    ...
    r"""Variant of 2D grouped convolution.

    This operator takes the weight as the group convolution kernel
    and convolves it with data to produce an output, following a specialized
    NCHWc data layout.
    ...
    # convert 2-way padding to 4-way padding
    padding = get_pad_tuple2d(padding)
    return _make.contrib_group_conv2d_NCHWc(
        data,
        kernel,
        strides,
        padding,
